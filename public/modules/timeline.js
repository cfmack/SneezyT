define(["timeline"], function(timeline) {
    return {
        initialize: function _timeline_initialize(the_date) {
            ...
            function loadTimeline() {
                ...
                var d = the_date + " 00:00:00 GMT-0600";
                ...
                tl.loadJSON(base_url + "index.php/result/get_timeline_data/", function(json, url) {
