...
class Auth extends CI_Controller {
    ...
    function create_user()
    {
        ...
        $active_user_count = $this->ion_auth->count_active_users();
        if ($active_user_count > $this->config->item('registration_user_limit', 'ion_auth'))
        {
            $this->_render_page('auth/registration_limit', $this->data);
        }
        else
        {
