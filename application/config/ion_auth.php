 ...
 */
$config['site_title']                 = "sneezyt.com";       // Site Title, example.com
$config['admin_email']                = "admin@sneezyt.com"; // Admin Email, admin@example.com
...
/*
 ...
 | -------------------------------------------------------------------------
 */
$config['registration_user_limit'] = 200;
